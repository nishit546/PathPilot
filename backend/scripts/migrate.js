...
const STATEMENTS = [
  ...
  `ALTER TABLE public.cities ADD COLUMN IF NOT EXISTS popularity INT DEFAULT 90;`,
  `ALTER TABLE public.activities ADD COLUMN IF NOT EXISTS popularity INT DEFAULT 85;`,
  `ALTER TABLE public.day_activities ADD COLUMN IF NOT EXISTS end_time TIME;`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_days_section_id ON public.days(section_id);`,
...
async function runMigrations() {
  console.log('Running PostgreSQL migrations statement by statement...');
